...
type CurrentUser = { fullName: string | null; email: string };
...
function toggleDropdown(e: React.MouseEvent<HTMLButtonElement, MouseEvent>) {
  ...
  return (
    <div className="relative">
      ...
      >
        <span className="mr-3 flex h-10 w-10 items-center justify-center rounded-full bg-brand-500 text-sm font-semibold text-white">
